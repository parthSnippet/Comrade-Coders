...
function AboutUs() {
  ...
  useEffect(() => {
    request(apiConfig.api.endpoints.about);
  }, [request]);
  ...
  const stats = about
    ? [
        { value: about.projects_delivered, label: "Projects Delivered" },
        { value: about.happy_clients, label: "Happy Clients" },
        { value: about.years_experience, label: "Years Experience" },
        { value: about.tech_experts, label: "Tech Experts" },
      ]
    : [];
  ...
  return (
    <section id="about" className="relative bg-white py-24 dark:bg-[#05070b]">
      ...
      <div className="mx-auto max-w-[1280px] px-5 sm:px-8 lg:px-10">
        ...
        <div
          ref={headerRef}
          className="reveal mb-16 grid gap-10 lg:grid-cols-2 lg:items-end"
        >
          <div>
        ...
        <div
          ref={statsRef}
          className="reveal-stagger mb-16 grid grid-cols-2 gap-4 sm:grid-cols-4"
        >
          {loading
            ? Array.from({ length: 4 }).map((_, index) => (
                ...
                >
                  <div className="mx-auto h-10 w-20 animate-pulse rounded-lg bg-black/[0.06] dark:bg-white/[0.06]" />
                  <div className="mx-auto mt-3 h-4 w-24 animate-pulse rounded bg-black/[0.05] dark:bg-white/[0.05]" />
                </div>
              ))
            : stats.map((s) => (
                <div
                ...
                >
                  ...
                  <div className="mt-2 text-[13px] text-black/50 dark:text-white/50">
                    {s.label}
                  </div>
                </div>
              ))}
        ...
        {/* API Error */}
        {error && (
          <div className="mb-8 rounded-2xl border border-red-500/20 bg-red-500/5 px-5 py-4 text-sm text-red-600 dark:text-red-400">
        ...
        <div className="grid gap-10 lg:grid-cols-[1fr_1fr]">
            ...
            {values.map((v) => {
              ...
              return (
                ...
                >
                  ...
                  <div>
                    <h3 className="mb-1.5 text-[15px] font-semibold text-[#05070b] dark:text-white">
                      {v.title}
                    </h3>

                    <p className="text-[13.5px] leading-6 text-black/50 dark:text-white/50">
                      {v.desc}
                    </p>
                  </div>
                </div>
          ...
          <div
            ref={rightRef}
            className="reveal-right rounded-2xl border border-black/[0.07] bg-black/[0.02] p-7 dark:border-white/[0.07] dark:bg-white/[0.03]"
          >
