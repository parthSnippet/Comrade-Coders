...
const posts = [
  {
    ...
    title: "Why AI workflows fail without process clarity",
    excerpt:
      "The smartest AI systems still fail when your teams lack clean handoffs, decision rules, and ownership.",
    readTime: "5 min read",
    accent: "from-cyan-400 via-blue-500 to-sky-700",
  },
  {
    category: "Automation",
    title: "The hidden cost of manual operations in growing teams",
    excerpt:
      "Most bottlenecks are not technical—they are operational. Smarter automation creates momentum, not just speed.",
    readTime: "4 min read",
    accent: "from-violet-400 via-purple-500 to-indigo-700",
  },
  {
    category: "Product",
    title: "What a strong digital foundation actually looks like",
    excerpt:
      "A modern product system is not just pretty UI. It is data flow, speed, trust, and a team that can ship again.",
    readTime: "6 min read",
...
export default function BlogSection() {
  return (
    <section className="relative bg-[#f7f9fc] py-24 text-[#05070b] dark:bg-[#05070b] dark:text-white sm:py-32">
      <div className="mx-auto max-w-[1280px] px-5 sm:px-8 lg:px-10">
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          {posts.map((post) => (
            ...
            >
              <div className={`relative h-52 overflow-hidden bg-gradient-to-br ${post.accent}`}>
              ...
              <div className="p-6 sm:p-7">
                <div className="mb-3 flex items-center justify-between gap-3">
                  ...
                  <ArrowUpRight size={14} className="text-black/45 transition-transform duration-300 group-hover:-translate-y-0.5 group-hover:translate-x-0.5 dark:text-white/45" />
                </div>
