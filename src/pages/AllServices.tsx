            ...
            {services.map((s) => {
              ...
              return (
                ...
                >
                  ...
                  <h2 className="mb-1.5 text-[16px] font-semibold text-[#05070b] dark:text-white">{s.title}</h2>
                  <p className="mb-3 text-[13px] font-medium text-[#2f8fe6] dark:text-[#58adff]">{s.tagline}</p>
                  <p className="flex-1 text-[14px] leading-6 text-black/50 dark:text-white/50">{s.desc.slice(0, 120)}…</p>
