...
const projectTypeValues: Record<string, string> = {
...
export default function ContactPage() {
  ...
  const handleBookCall = () => {
    ...
    window.location.href = `mailto:info@comradecoders.com?subject=${encodeURIComponent(
      "Book a Call"
    )}&body=${encodeURIComponent(
      "Hi Comrade Coders, I would like to book a call.\n\nPreferred time:\n\nCompany:\n\nProject overview:"
    )}`;
  };
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    /*
     * Book a Call does not create a normal project lead.
     * Keep the existing phone/email behaviour.
     */
    ...
    const response = await request(
      apiConfig.api.endpoints.contact,
      "POST",
      payload
    );
    ...
    <div className="min-h-screen bg-white text-[#05070b] dark:bg-[#05070b] dark:text-white">
      ...
      <main className="relative overflow-hidden pt-32 pb-24">
        <div className="pointer-events-none absolute inset-0">
          ...
          <div
            className="contact-orb absolute right-[8%] top-[10%] h-[350px] w-[350px] rounded-full bg-[#58adff]/8 blur-[90px]"
            ...
            <section className="relative">
              <div className="contact-panel rounded-[24px] border border-black/[0.08] bg-white/80 p-5 shadow-[0_18px_50px_rgba(0,0,0,0.08)] backdrop-blur-xl dark:border-white/[0.08] dark:bg-[#0b1120]/80 dark:shadow-[0_18px_50px_rgba(0,0,0,0.38)] sm:p-6">
                ...
                <p className="max-w-[500px] text-[14px] leading-6 text-black/55 dark:text-white/55">
                  Whether it is a website, automation workflow, AI product,
                  or a custom software system, we can help you turn idea
                  into execution.
                </p>
                ...
                <div className="mt-6 space-y-3">
                  <div className="contact-card flex items-center gap-3 rounded-2xl border border-black/[0.07] bg-black/[0.02] p-3 dark:border-white/[0.08] dark:bg-white/[0.03]">
                    ...
                    <div>
                      ...
                      <a
                        href="mailto:info@comradecoders.com"
                        className="mt-1 block text-[13px] font-medium text-black/70 hover:text-[#2f8fe6] dark:text-white/75 dark:hover:text-[#58adff]"
                      >
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="mt-1 text-[13px] font-medium text-black/70 dark:text-white/75">
                          {callNumber}
                        </p>
                      </div>
                    </div>
                  ...
                  <div
                    className="contact-card flex items-center gap-3 rounded-2xl border border-black/[0.07] bg-black/[0.02] p-3 dark:border-white/[0.08] dark:bg-white/[0.03]"
              ...
              <div className="contact-panel rounded-[24px] border border-black/[0.08] bg-white/90 p-5 shadow-[0_18px_55px_rgba(0,0,0,0.08)] backdrop-blur-xl dark:border-white/[0.08] dark:bg-[#0d1421]/90 dark:shadow-[0_18px_55px_rgba(0,0,0,0.35)] sm:p-6">
                <div className="mb-4 flex items-center justify-between gap-4">
                  <div>
                    ...
                    <h2 className="mt-1 font-['Montserrat'] text-[1.2rem] font-bold tracking-[-0.03em]">
                ...
                >
                  <div className="grid gap-3 sm:grid-cols-2">
                    <div>
                      <label
                        htmlFor="name"
                        className="mb-1.5 block text-[10px] font-medium uppercase tracking-[0.14em] text-black/45 dark:text-white/45"
                      >
                        Name
                      </label>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={handleChange}
                      rows={4}
                      placeholder="Tell us about your goals, challenges, and what you want to build..."
                  ...
                  <div className="flex flex-col gap-2.5 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <Link
                      to="/services"
                      className="inline-flex items-center gap-2 text-[12px] font-medium text-black/60 transition-colors hover:text-[#2f8fe6] dark:text-white/60 dark:hover:text-[#58adff]"
                    >
                      Browse services
                      <ArrowRight size={12} />
                    </Link>
                  ...
                  {submitted && (
                    <div className="flex items-start gap-3 rounded-2xl border border-emerald-500/20 bg-emerald-500/10 px-3 py-2.5 text-[12px] text-emerald-700 dark:text-emerald-300">
                      ...
                      <span>
                        Thanks! Your project inquiry has been submitted
                        successfully. Our team will get back to you within
                        24 hours.
                      </span>
                    </div>
                  )}
                  ...
                  {apiError && !submitted && (
                    <div className="rounded-2xl border border-red-500/20 bg-red-500/10 px-3 py-2.5 text-[12px] text-red-600 dark:text-red-300">
                      {apiError}
                    </div>
                  )}
                </form>
