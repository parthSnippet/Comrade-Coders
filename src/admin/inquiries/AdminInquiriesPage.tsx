...
const STATUS_STYLES: Record<string, string> = {
  ...
  closed: "bg-black/[0.06] text-black/50 dark:bg-white/[0.06] dark:text-white/45",
};
        ...
        {error && !loading && (
          <div className="px-5 py-8 text-center">
            ...
            <p className="mt-1 text-xs text-black/40 dark:text-white/35">
              Backend GET endpoint is not available.
            </p>
          </div>
        )}
            ...
            <div className="flex-1 space-y-5 overflow-y-auto px-6 py-5">
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                <div className="flex items-center gap-3 rounded-xl border border-black/[0.07] bg-black/[0.02] p-3 dark:border-white/[0.08] dark:bg-white/[0.03]">
                  ...
                  <div className="min-w-0">
                    <p className="text-[10px] font-semibold uppercase tracking-[0.14em] text-black/40 dark:text-white/35">
                      Email
                    </p>

                    <a
                      href={`mailto:${selected.email}`}
                      className="block truncate text-xs font-medium text-black/70 hover:text-[#2f8fe6] dark:text-white/70 dark:hover:text-[#58adff]"
                    >
                      {selected.email}
                    </a>
                  </div>
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                <div className="rounded-xl border border-black/[0.07] bg-black/[0.02] p-3 dark:border-white/[0.08] dark:bg-white/[0.03]">
                  ...
                  <p className="text-sm font-semibold">
                    {PROJECT_TYPE_LABELS[selected.project_type] ??
              ...
              {selected.project_brief && (
                <div className="rounded-xl border border-black/[0.07] bg-black/[0.02] p-4 dark:border-white/[0.08] dark:bg-white/[0.03]">
                  <p className="mb-2 text-[10px] font-semibold uppercase tracking-[0.14em] text-black/40 dark:text-white/35">
                    Project Brief
                  </p>

                  <p className="text-sm leading-6 text-black/65 dark:text-white/60">
                    {selected.project_brief}
                  </p>
                </div>
              )}
              ...
              {/* Status update */}
              <div>
                <p className="mb-2 text-xs font-semibold text-black/50 dark:text-white/45">
                  Update status
                </p>
